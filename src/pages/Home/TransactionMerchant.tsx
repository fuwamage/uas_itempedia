...
const TransactionMerchant: React.FC = () => {
                            ...
                            <IonRow>
                                <IonCol size-sm="8" offset-sm="2" size-md="3" offset-md="4.4">
                                    <IonCol className='flex'>
                                        ...
                                        <IonTitle><span className="header-title">Transaksi Merchant</span></IonTitle>
                                    </IonCol>
                                    <IonSegment className="segementbutton" value={selectedSegment} scrollable={true} color="primary-cust-2">
                                        <IonSegmentButton value="incomingorder" onClick={() => selectSegment('incomingorder')}>
                                            <IonLabel className="segment-txt">Waiting for payment</IonLabel>
                                        </IonSegmentButton>
                                        <IonSegmentButton value="waitinguserconfirmation" onClick={() => selectSegment('waitinguserconfirmation')}>
                                            <IonLabel className="segment-txt">Waiting for delivery</IonLabel>
                                        </IonSegmentButton>
                                        <IonSegmentButton value="canceledorder" onClick={() => selectSegment('canceledorder')}>
                                            <IonLabel className="segment-txt">Item sent</IonLabel>
                                        </IonSegmentButton>
                                        <IonSegmentButton value="outofstock" onClick={() => selectSegment('outofstock')}>
